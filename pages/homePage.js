...
import "../images/pngtree-modern-kids-furniture-banner-with-copy-space-store-banner-bed-photo-image_48999120.jpg";
...
const HomePage = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${require("../images/pngtree-modern-kids-furniture-banner-with-copy-space-store-banner-bed-photo-image_48999120.jpg")})`,
      }}>
      ...
      <div className=" flex">
        <div className=" flex">
          <div className="border-icon border-2px "><i className="fa-solid fa-user-tie font-size text-lg"></i></div>
          <div>
            <h3 className=" font-bold text-lg text-yellow-400 uppercase">Professionals</h3>
        ...
        <div>
          <div></div>
          <div>
            <h3 className=" font-bold text-lg text-yellow-400 uppercase">Trusted</h3>
            <p className=" text-mx font-bold text-gray-800">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry.
            </p>
        ...
        <div>
          <div></div>
          <div>
            <h3 className=" font-bold text-lg text-yellow-400 uppercase">Export Design</h3>
            <p className=" text-mx font-bold text-gray-800">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry.
            </p>
